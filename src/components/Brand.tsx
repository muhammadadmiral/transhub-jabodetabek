...
export function Brand({ variant = "full" }: BrandProps) {
  ...
  return (
    <div className="brand-container">
      ...
      {!isMark && (
        <div className="brand-tooltip" title="Made with love by Admiral">
          Made with <Heart className="brand-tooltip__heart" size={11} fill="currentColor" /> by <span className="brand-tooltip__author">Admiral</span>
        </div>
      )}
    </div>
  );
